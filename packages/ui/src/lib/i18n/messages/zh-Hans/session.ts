export const sessionMessages = {
  ...
  "filePreview.label": "预览文件",
  "filePreview.urlLabel": "预览网页",
  "filePreview.enterPath": "输入文件路径",
  "filePreview.enterUrl": "输入网页地址",
  "filePreview.loading": "加载中...",
  "filePreview.fullscreen": "全屏",
  ...
  "autoContinue.maxTriggers": "最大触发次数",
  "autoContinue.cooldown": "间隔时间",
  "autoContinue.seconds": "秒",
  "autoContinue.prompt": "提示词",
  "autoContinue.promptPlaceholder": "AI 自动续跑时的提示词...",
  "autoContinue.triggered": "已触发 {count}/{max} 次",
