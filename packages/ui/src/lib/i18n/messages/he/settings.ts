export const settingsMessages = {
  ...
  "settings.nav.tunnel": "Tunnel",
  "settings.tunnel.title": "Tunnel Service",
  "settings.tunnel.subtitle": "Configure tunnel service to expose local services to the public internet.",
  "settings.tunnel.hubUrl.title": "Tunnel Hub URL",
  "settings.tunnel.hubUrl.subtitle": "The base URL of the tunnel hub server that relays public traffic to your local services.",
  "settings.tunnel.test.label": "Test",
  "settings.tunnel.test.testing": "Testing...",
  "settings.tunnel.status.connected": "Connected to {hubUrl}",
  "settings.tunnel.status.disconnected": "{error}",
  "settings.tunnel.status.failed": "Connection failed",
  "settings.tunnel.saving": "Saving configuration...",
