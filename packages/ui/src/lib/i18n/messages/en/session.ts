export const sessionMessages = {
  ...
  "filePreview.label": "Preview File",
  "filePreview.urlLabel": "Preview URL",
  "filePreview.enterPath": "Enter file path",
  "filePreview.enterUrl": "Enter URL to preview",
  "filePreview.loading": "Loading...",
  "filePreview.fullscreen": "Fullscreen",
  ...
  "autoContinue.maxTriggers": "Max triggers",
  "autoContinue.cooldown": "Interval",
  "autoContinue.seconds": "seconds",
  "autoContinue.prompt": "Prompt",
  "autoContinue.promptPlaceholder": "Continuation prompt for the AI...",
  "autoContinue.triggered": "{count}/{max} triggered",
